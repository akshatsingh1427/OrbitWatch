...
const TABS: { id: TabId; label: string; icon: typeof LayoutDashboard; shortcut: string }[] = [
  ...
  { id: "telemetry", label: "Telemetry", icon: Activity, shortcut: "2" },
  { id: "comms", label: "Comms & Health", icon: Radio, shortcut: "3" },
  { id: "timeline", label: "Timeline", icon: GitBranch, shortcut: "4" },
  { id: "resources", label: "Resources", icon: BatteryCharging, shortcut: "5" },
];
