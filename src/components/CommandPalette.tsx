...
import { Search, ArrowRight, LayoutDashboard, Activity, Radio, GitBranch, BatteryCharging } from "lucide-react";
...
export default function CommandPalette() {
  const { paletteOpen, setPaletteOpen, setActiveTab, setSelectedMissionId, setSearchQuery } = useStore();
          ...
          >
            <div className="flex items-center gap-3 px-4 py-3 border-b border-space-border">
              ...
              <input
                ...
                placeholder="Search tabs, missions, callsigns..."
